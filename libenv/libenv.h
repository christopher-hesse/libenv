...
// libenv_load is called when the environment library is loaded
LIBENV_API void libenv_load();
...
// libenv_close closes the environment and free any resources associated with it
LIBENV_API void libenv_close(libenv_venv *handle);

// libenv_unload is called when the last environment is closed and the shared library is unloaded
LIBENV_API void libenv_unload();
