"""
Python adapter for the libenv interface

Load and unload shared objects that expose the libenv interface, convert types back and forth
"""
...
global_open_count_lock = threading.Lock()
global_open_count: Dict[str, int] = collections.defaultdict(int)
...
def scalar_adapter(venv_cls: Type[CVecEnv]):
    class ScalarEnv:
        """
        This is just a scalar wrapper around a CVecEnv
        ...
        interface handles resets.  In addition, you are not allowed to step this
